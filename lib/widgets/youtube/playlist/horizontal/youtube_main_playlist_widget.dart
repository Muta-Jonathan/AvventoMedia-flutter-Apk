...
class YoutubeMainPlaylistWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<YoutubePlaylistModel>>(
      stream: FirestoreServiceAPI.instance.streamPlaylists(AppConstants.avventoMainChannel),
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: Column(
            children: [
              LabelPlaceHolder(
                title: AppConstants.avventoMain,
                titleFontSize: 18,
                moreIcon: true,
                onMoreTap: () => Get.toNamed(Routes.getYoutubeMainPlaylistRoute()),
              ),
              Expanded(
